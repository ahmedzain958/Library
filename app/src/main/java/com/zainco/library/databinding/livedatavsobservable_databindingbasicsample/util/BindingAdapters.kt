...
package com.zainco.library.databinding.livedatavsobservable_databindingbasicsample.util
...
import com.zainco.library.databinding.livedatavsobservable_databindingbasicsample.data.Popularity

/*
Binding adapters let you customize or create layout attributes.
For example, you can create an app:progressTint attribute for progress bars where you change the color of the progress indicator depending on an external value.*/

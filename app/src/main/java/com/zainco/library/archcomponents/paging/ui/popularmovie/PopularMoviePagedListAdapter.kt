...
import com.zainco.library.archcomponents.paging.ui.singlemoviedetails.SingleMovieActivity
...
class PopularMoviePagedListAdapter( val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val view: View
//here there are 2 types of views one for movie view item and the other is for the network state item
    ...
    private fun hasExtraRow(): Boolean {
        return networkState != null && networkState != NetworkState.LOADED//error or loading
    }

...
import com.zainco.library.androiddevsrunningtracker.other.Constants.REQUEST_CODE_LOCATION_PERMISSION
...
class RunFragment : Fragment(R.layout.fragment_run), EasyPermissions.PermissionCallbacks {
    ...
    private fun requestPermissions() {
        if (TrackingUtility.hasLocationPermissions(requireContext()/*makes sure that the activity? isn't equal to null*/)) {
            return
        }

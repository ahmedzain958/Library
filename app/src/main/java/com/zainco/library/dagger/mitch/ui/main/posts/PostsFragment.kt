...
import com.zainco.library.dagger.mitch.VerticalSpaceItemDecoration
...
class PostsFragment : DaggerFragment() {
    ...
    @Inject
    lateinit var factory: ViewModelProviderFactory // user the injected Factory to solve dagger/viewModel issue
    @Inject
    lateinit var adapter: PostRecyclerAdapter //  use the injected adapter in MainModule
    @Inject
    lateinit var layoutManager: LayoutManager // user the injected layoutManager in MainModule
